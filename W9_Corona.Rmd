...
Getting a plot of the world map takes only three lines:
...
To look at the global historical data in ncov2019 package, you need to use the `load_nCov2019` function and then subset via `y['global', ]`:
...
head(d)
```
# A heatmap of the global situation in the last 7 days
...
My colleague was right. What has made this difference possible? Was Belgium more lax about lock down? Do we see the effect of higher population density or greater proportion of aging population or simply high density of politicians?
